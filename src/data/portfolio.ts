...
export const skills: Skill[] = [
    ...
    { name: 'Framer Motion', category: 'Frontend', badge: { label: 'Framer Motion', color: '0055ff', logoSlug: 'framer' } },
    ...
    { name: 'Google Stitch', category: 'Backend', badge: { label: 'Google Stitch', color: '4285f4', logoSlug: 'google' } },
